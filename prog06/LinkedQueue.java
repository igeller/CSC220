...
public class LinkedQueue<E> extends AbstractQueue<E>
    ...
    public boolean offer (E item) {
        ...
        size++;			//must increment because something was added to the queue
        return true;
    }
    ...
    public E poll () {
      ...
      // EXERCISE 4       				//check for empty and return null sometimes
    ...
    private class Iter implements Iterator<E> {
      ...
      public boolean hasNext () {
    	  	if(next == null)
    	  		return false;
    	  	return true; // EXERCISE 4:  fix this.	//value of null says that hasNext() is false
      }
      /**
      ...
      public E next () {
        ...
        // EXERCISE 4	//if not hasnext throw the exception, otherwise save item at front and move next one forward next = next.next
        if(!hasNext()) {
